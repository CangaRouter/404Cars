            ...
            <Navbar  fixed="top" className="myNavbar">
                ...
                <Col className="user" xs={2}>
                    <Navbar.Collapse className="justify-content-center my-3 ">
                        <span className="mr-1 linkify white" onClick={() => props.showLogin()} >Login</span>
                            <Link className="mr-1 white" to={"/booking"} >booking</Link> 
                        <svg className="bi bi-person-circle ml-4" width="2em" height="2em" viewBox="0 0 16 16" fill="white" xmlns="http://www.w3.org/2000/svg">
